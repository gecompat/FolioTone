...
class ScanRootWriteOwnerKind(StrEnum):
    ...
    CONSOLIDATION_QUARANTINE_RUN = "CONSOLIDATION_QUARANTINE_RUN"
    METADATA_WRITE_PREPARATION = "METADATA_WRITE_PREPARATION"
    METADATA_WRITE_RUN = "METADATA_WRITE_RUN"
    EBOOK_RENAME_PREPARATION = "EBOOK_RENAME_PREPARATION"
    EBOOK_RENAME_RUN = "EBOOK_RENAME_RUN"
    EBOOK_FIXITY_BASELINE = "EBOOK_FIXITY_BASELINE"
    EBOOK_FIXITY_VERIFICATION = "EBOOK_FIXITY_VERIFICATION"
