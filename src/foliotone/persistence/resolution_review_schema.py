...
review_items = Table(
    ...
    CheckConstraint(
        "(review_type = 'FIXITY_EXPECTATION' AND candidate_kind = 'FIXITY_RESULT' "
        "AND subject_kind = 'FILE') OR (review_type <> 'FIXITY_EXPECTATION' "
        "AND candidate_kind <> 'FIXITY_RESULT')",
        name="ck_review_items_fixity_pair",
    ),
    CheckConstraint(
