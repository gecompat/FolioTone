# ruff: noqa: E501
"""Generate the complete deterministic synthetic input for GATE-0002."""
...
PROFILE = "ebook-transform-gate-0002-input/v1"
ZIP_TIME = (2026, 8, 26, 9, 0, 0)
...
<package xmlns="http://www.idpf.org/2007/opf" xmlns:dc="http://purl.org/dc/elements/1.1/" version="3.0" unique-identifier="book-id" prefix="calibre: https://calibre-ebook.com">
  <metadata>
    <dc:identifier>uuid:11111111-2222-4333-8444-555555555555</dc:identifier>
    ...
    <meta refines="#title" property="file-as">Ausgangstitel, Synthetischer</meta>
    <dc:creator id="creator">Ada Beispiel</dc:creator>
    <meta refines="#creator" property="role" scheme="marc:relators">aut</meta>
    <meta refines="#creator" property="file-as">Beispiel, Ada</meta>
    <dc:contributor id="translator">Berta Muster</dc:contributor>
    <meta refines="#translator" property="role" scheme="marc:relators">trl</meta>
    <meta refines="#translator" property="file-as">Muster, Berta</meta>
    <dc:language>de</dc:language>
    <dc:publisher>FolioTone Testverlag</dc:publisher>
    <dc:date>2026-08-01T00:00:00+00:00</dc:date>
    <dc:subject>Synthetik</dc:subject>
    <dc:subject>Qualifikation</dc:subject>
    <dc:description>Vollstaendig synthetische Beschreibung.</dc:description>
    <dc:rights>CC0-1.0</dc:rights>
    <dc:type>Text</dc:type>
    <meta property="calibre:rating">4</meta>
    <meta property="dcterms:modified">2026-08-26T09:00:00Z</meta>
    <meta property="belongs-to-collection" id="series">Synthetische Reihe</meta>
    <meta refines="#series" property="collection-type">series</meta>
    <meta refines="#series" property="group-position">1.5</meta>
  </metadata>
  <manifest>
...
def generate_fixture(output_dir: Path) -> dict[str, object]:
    """Generate byte-stable source and full reviewed metadata OPF."""
