...
| `MetadataWriteExecutionRun` | Immutable Identität genau eines Versuchs, einen `MetadataWriteAuthorizationSnapshot` unter einer frischen rootweiten Fence-Epoch zu verbrauchen. Vor `S-W10-MW04` besitzt der Run keinen Executor und keine Source-Mutation. | Batch-Write, wiederverwendbare Authorization, CLI-Command |
