...
offen. Die Korrektur verändert weder `WI-0003` als einzige `NEXT`-Wave noch
dessen Baseline-Scope und öffnet keine zusätzliche Source-Media-Operation.
...
Full-SHA-256-Fixity-Baseline für genau einen E-Book-`ScanRoot`: echte
