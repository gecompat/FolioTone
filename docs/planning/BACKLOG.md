...
| W3-021 | NEXT | FG-A-RUNTIME, S-EBAR-01/02, FG-A-IMAGE, S-EBAR-03/03A und EBAR-04 sind abgeschlossen. ADR-0043 schiebt nun S-EBAR-02A vor EBAR-05: Der additive Member-only-Parser v2 bildet den tatsächlichen festen `-ba -slt`-Stream einschließlich leerer Archive ab, ohne Banner, Header oder Raw-Artefakte zu akzeptieren. Danach folgen EBAR-05 für unverschlüsseltes Listing/Integrity und EBAR-06 für private sandboxed Testextraktion. stderr-Prosa und grobe 7-Zip-Exitcodes sind keine Ursachen-Authority; nicht strukturierte Fehler bleiben `TOOL_FAILED`. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
