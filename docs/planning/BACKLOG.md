...
| W3-024 | NEXT | S-EBAR-08A bis 08D setzen ADR-0053 in vier kleinen Wellen um: Models/Schema/Store, reine Planpartition, bounded Ausführung und read-only Status. Extraction, Secrets, Mutation und allgemeiner E-Book-Collection-Status bleiben getrennt. |
