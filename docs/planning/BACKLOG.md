...
| W3-021 | READY | FG-A-RUNTIME, S-EBAR-01/02, FG-A-IMAGE, S-EBAR-03/03A, EBAR-04, S-EBAR-02A bis S-EBAR-02C und EBAR-05 sind abgeschlossen. ADR-0046 und ADR-0047 entscheiden Storage Family und Formatlock; ADR-0048 entscheidet FG-A-EXTRACTION-LIFECYCLE. Als Nächstes folgen S-EBAR-05A für den privaten Listing-/CRC-Handoff, S-EBAR-06A für den reinen internen Extraction-Validator, FG-A-EXTRACTION-QUOTA für einen harten Linux-Workspace-Cap, S-EBAR-04Q für dessen unprivilegierte Quota-Slot-Capability, S-EBAR-04A für den Runner-owned Workspace-Consumer und danach EBAR-06 ausschließlich für direkte unverschlüsselte `MEASURED`-Fälle. Polling allein ist keine Budget-Authority. Komprimierte TAR-Wrapper bleiben bis FG-A-WRAPPER-PIPELINE `OUTER_COMPRESSION_ONLY`, Storage `UNKNOWN` und ohne Lauf. stderr-Prosa und grobe 7-Zip-Exitcodes bleiben ohne Ursachen-Authority. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
