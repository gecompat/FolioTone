...
| W3-017 | NEXT | Run a read-only pilot and then the complete confirmed local collection analysis through the host context after W3-015/W3-016; record scale, runtimes, failure classes and actionable collection findings without changing source media or committing private paths/data. |
