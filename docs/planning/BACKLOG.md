...
`NOT_EXECUTABLE`; die W9-Non-Execution-Grenze bleibt unverändert. Die einzige
Ausnahme ist die getrennte, kurzlebig autorisierte ADR-0056-Interim-Quarantäne.
