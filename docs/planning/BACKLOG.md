...
| W3-021 | NEXT | FG-A-RUNTIME, S-EBAR-01/02, FG-A-IMAGE, S-EBAR-03/03A, EBAR-04 und S-EBAR-02A sind abgeschlossen. Die reale Golden-Prüfung hat Parser v2 für alle neun vorgesehenen Familien fail-closed abgewiesen. ADR-0044 legt deshalb vor EBAR-05 die Folge S-EBAR-02B (hash-/lizenzgebundener Fixturekorpus und Linux-Messmanifest), FG-A-FORMAT-LOCK und S-EBAR-02C (formatgebundene Produktionsparser) fest. Komprimierte TAR-Wrapper benötigen erst in EBAR-06 eine private begrenzte Dekompression und erneute Signaturprüfung; EBAR-05 darf keine inneren Member erfinden. stderr-Prosa und grobe 7-Zip-Exitcodes bleiben ohne Ursachen-Authority. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
