...
| W3-021 | READY | FG-A-RUNTIME bis EBAR-05 sowie S-EBAR-05A und S-EBAR-06A sind abgeschlossen. ADR-0046 und ADR-0047 entscheiden Storage Family und Formatlock; ADR-0048 entscheidet den privaten Extraction-Lifecycle. ADR-0049 entscheidet FG-A-EXTRACTION-QUOTA als dateisystemneutrale, atomar begrenzte Workspace-Capability. Als Nächstes implementiert S-EBAR-04Q ausschließlich den neutralen Provider-, Lease-, Capability-, Empty-Revalidation-, Return- und Quarantänevertrag. Reale Backends folgen getrennt je Plattform mit nicht überspringbarem Konformitätsgate; FolioTone erhält keine Mount-/Device-/Root-Authority. Danach folgen S-EBAR-04A und EBAR-06 ausschließlich für direkte unverschlüsselte `MEASURED`-Fälle. Polling bleibt nur Frühabbruch. Wrapper bleiben bis FG-A-WRAPPER-PIPELINE ohne Lauf; W10 und Source-Mutation bleiben blockiert. |
