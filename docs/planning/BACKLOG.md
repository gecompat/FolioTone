...
|---|---|---|
| NOW | `S-W10-MW03` | `S-W10-MW01` und `S-W10-MW02` liefern Preflight, Zwei-Spannen-Patch, privates Streaming-Staging und feste unabhängige Verifikation ohne Source-Commit. Der nächste Slice ergänzt ausschließlich Authorization-/Run-/Eventpersistenz, Capability-Auflösung, Root-Lease/Fencing und read-only Status. |
...
| NEXT WAVES | `S-W10-MW03` bis `S-W10-MW05` | Authorization/Persistenz, Linux-Exchange/Recovery und feste CLI/Reconciliation bleiben getrennte kleine Waves. Reale Source-Mutation bleibt bis zum Abschluss der gesamten Kette geschlossen. |
...
| S-W10-MW03 | NEXT | Ergänze immutable Authorization-/Run-/Eventpersistenz, Capability-Auflösung, `ScanRootWriteLease`-/Fence-Vertrag und privacy-begrenzten read-only Status. |
