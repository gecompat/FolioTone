...
| S-W10-05A | READY | Implementiere ausschließlich den privaten `QuarantineCapabilityResolver`: `FOLIOTONE_QUARANTINE_CAPABILITIES_FILE` auf eine bounded lokale JSON-Zuordnung aus opaque Capability-ID, ScanRoot-ID und privaten absoluten Verzeichnissen auflösen. Fail closed bei fehlender/unsicherer Konfiguration, unbekannten Feldern, Duplikaten, relativen/überlappenden Pfaden, Symlink-/Reparse-Komponenten oder ungültigen Verzeichnissen. Keine CLI, Persistenz, Reports oder Executor-Aufrufe. |
