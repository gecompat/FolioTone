...
| W3-024 | IN PROGRESS | S-EBAR-08A ist mit Models, Migration `0020`, geschlossenem Store und Fencing abgeschlossen. S-EBAR-08B bis 08D liefern als nächste kleine Wellen reine Planpartition, bounded Ausführung und read-only Status. Extraction, Secrets, Mutation und allgemeiner E-Book-Collection-Status bleiben getrennt. |
