...
| W3-021 | READY | FG-A-RUNTIME, S-EBAR-01/02, FG-A-IMAGE, S-EBAR-03/03A, EBAR-04, S-EBAR-02A und S-EBAR-02B sind abgeschlossen. S-EBAR-02B2 ist implementiert und bindet eine geschlossene 5×8-Matrix, 18 öffentliche beziehungsweise synthetische Fixtures, strikte `VT_BOOL`-Klassifikation und byteidentische Doppelmessung; der unabhängige Review ist ohne P0/P1 abgeschlossen, das einmalige PR-Gate entscheidet die Annahme. Danach folgen FG-A-STORAGE-FAMILY, finaler FG-A-FORMAT-LOCK, S-EBAR-02C und erst anschließend EBAR-05. Das Storage-Gate trennt ZIP/RAR4/RAR5/7z/TAR orthogonal von EPUB/CBZ/CBR. Nicht belegbare Fälle bleiben formatgebunden unsupported/fail-closed. Komprimierte TAR-Wrapper bleiben bis EBAR-06 `OUTER_COMPRESSION_ONLY`. stderr-Prosa und grobe 7-Zip-Exitcodes bleiben ohne Ursachen-Authority. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
