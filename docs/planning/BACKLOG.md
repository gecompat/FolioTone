...
| W3-021 | NEXT | FG-A-RUNTIME, S-EBAR-01/02, FG-A-IMAGE, S-EBAR-03/03A, EBAR-04, S-EBAR-02A und S-EBAR-02B sind abgeschlossen. ADR-0045 verwirft den Happy-Path-Lockkandidaten als diagnostisch und legt die neue Folge S-EBAR-02B2, FG-A-STORAGE-FAMILY, finaler FG-A-FORMAT-LOCK, S-EBAR-02C und erst danach EBAR-05 fest. S-EBAR-02B2 erweitert Directory-/Encryption-/Link-Evidence und korrigiert die `VT_BOOL`-Klassifikation; das Storage-Gate trennt ZIP/RAR4/RAR5/7z/TAR orthogonal von EPUB/CBZ/CBR. Nicht belegbare Fälle bleiben formatgebunden unsupported/fail-closed. Komprimierte TAR-Wrapper bleiben bis EBAR-06 `OUTER_COMPRESSION_ONLY`. stderr-Prosa und grobe 7-Zip-Exitcodes bleiben ohne Ursachen-Authority. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
