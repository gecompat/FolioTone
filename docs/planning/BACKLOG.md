...
| FG-W10-MOVE-BACKEND | BLOCKED | Späterer Frontier-Nachweis für einen konkreten Linux-Backendadapter über `renameat2(..., RENAME_NOREPLACE)`. Der Host-Grundtest für Collision und Same-Filesystem-Move ist synthetisch bestanden; vor Akzeptanz fehlen reproduzierbare Cross-Device-, Race-, Crash-/Recovery- und no-follow-Elternverzeichnis-Nachweise. Bis dahin keine reale Source-Media-Mutation und kein Fallback über Copy+Delete oder generische Filesystem-Operationen. |
