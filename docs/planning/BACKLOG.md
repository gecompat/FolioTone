...
| W3-021 | READY | FG-A-RUNTIME, S-EBAR-01/02, FG-A-IMAGE, S-EBAR-03/03A, EBAR-04, S-EBAR-02A, S-EBAR-02B und S-EBAR-02B2 sind abgeschlossen. ADR-0046 entscheidet FG-A-STORAGE-FAMILY; ADR-0047 akzeptiert den finalen maschinenlesbaren Formatlock. Als Nächstes folgen S-EBAR-02C und danach EBAR-05. Nicht belegbare Fälle und Routingwidersprüche bleiben formatgebunden fail-closed. Komprimierte TAR-Wrapper bleiben bis EBAR-06 `OUTER_COMPRESSION_ONLY` mit Storage `UNKNOWN`. stderr-Prosa und grobe 7-Zip-Exitcodes bleiben ohne Ursachen-Authority. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
