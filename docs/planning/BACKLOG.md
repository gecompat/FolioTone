...
| W3-021 | NEXT | FG-A-RUNTIME, S-EBAR-01, S-EBAR-02 und FG-A-IMAGE sind durch ADR-0039, Implementierung und ADR-0040 abgeschlossen. Als Nächstes setzt S-EBAR-03 das projekt-eigene `linux/amd64`-`scratch`-Rezept, feste 7zz-/Lizenzinputs, UID/GID `65532:65532`, das gepinnte Buildx-/BuildKit-Profil, den zweistufigen Plattform-Manifest-Digest-Lock, SBOM/Provenance, Toolmanifest und feste Command Builder mechanisch um. Bis zum identischen geschützt publizierten und nachträglich attestierten Digest sowie öffentlicher/source-associated GHCR-Konfiguration und anonymer Digestverifikation bleibt `archive-linux-container-runner/v1` `TOOL_UNAVAILABLE`; danach folgen EBAR-04 bis EBAR-06 für isolierten Runner, unverschlüsseltes Listing/Integrity und private sandboxed Testextraktion. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
