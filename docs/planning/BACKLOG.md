...
| W3-022 | NEXT | ADR-0052 schließt FG-A-PERSISTENCE mit der additiven Migration `0019_archive_evidence`, fünf dedizierten insert-only Tabellen, exakter Source-/Execution-/Wrapper-Lineage, konservativem Erfolgs-Reuse und ScanRoot-Fencing ab. S-EBAR-07 setzt diesen Vertrag als Nächstes mechanisch um. Extraction, Secrets, Source-Mutation und Collection-Orchestrierung bleiben ausgeschlossen; CBR/CBZ/EPUB bleiben von entbehrlicher Verpackung getrennt. |
