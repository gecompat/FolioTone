...
| W3-021 | READY | FG-A-RUNTIME bis EBAR-05 sowie S-EBAR-05A, S-EBAR-06A und das neutrale S-EBAR-04Q sind abgeschlossen. ADR-0046 und ADR-0047 entscheiden Storage Family und Formatlock; ADR-0048 entscheidet den privaten Extraction-Lifecycle; ADR-0049 die dateisystemneutrale, atomar begrenzte Workspace-Capability. Die Adapter-Allowlist bleibt absichtlich leer. Als Nächstes entscheidet FG-A-WORKSPACE-BACKEND das erste konkrete Plattformpaket und dessen nicht überspringbares Konformitätsgate; FolioTone erhält keine Mount-/Device-/Root-Authority. Danach folgen S-EBAR-04A und EBAR-06 ausschließlich für direkte unverschlüsselte `MEASURED`-Fälle. Polling bleibt nur Frühabbruch. Wrapper bleiben bis FG-A-WRAPPER-PIPELINE ohne Lauf; W10 und Source-Mutation bleiben blockiert. |
...
| S-EB07-11B | PLANNED | Read-only Capture-Orchestrierung mit keyset-paginiertem Vorher-/Nachher-Inventar, OPF-Projektion, Lease-Keeper und atomarer Snapshot-Persistenz. |
...
Bibliothek bleibt `S-EB07-11B`. EB-08, Archiv-Evidence und die
