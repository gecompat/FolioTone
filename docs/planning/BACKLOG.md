...
| W3-024 | IN PROGRESS | S-EBAR-08A und 08B sind mit Models, Migration `0020`, geschlossenem Store, Fencing und restartbarer Planpartition abgeschlossen. S-EBAR-08C und 08D liefern als nächste kleine Wellen bounded Ausführung und read-only Status. Extraction, Secrets, Mutation und allgemeiner E-Book-Collection-Status bleiben getrennt. |
