...
| W3-023 | NEXT | FG-A-COLLECTION-ORCHESTRATION legt vor EBAR-08 den fehlenden Planungs-, Lease-/Fencing-, Resume-, Heartbeat-, Batch- und path-freien Reportvertrag einschließlich exaktem Datei-/Migrationsscope fest. Der bestehende allgemeine E-Book-Collection-Vertrag darf nicht stillschweigend für Archive wiederverwendet werden. |
