...
| DECISION | `DEC-0002`, `FG-W10-SIDECAR-WRITE`, `FG-W10-EXTERNAL-LIBRARY-WRITE`, `FG-W10-REORGANIZE`, `FG-W10-ARCHIVE-REWRITE`, W10-003, W10-004 | Das rohe calibre-9.13.0-Profil ist wegen Zeit-/ZIP-Drift und verlorener Preserved Fields abgelehnt. `DEC-0002` benötigt eine ausdrückliche Folgerichtung. |
...
| GATE-0001 | DONE | calibre 9.13.0 mit festem `ebook-polish --opf`-Profil scheitert an exakter Byte-Reproduzierbarkeit und Preserved Fields; der pfadfreie Nachweis liegt unter `docs/quality/GATE_0001_EPUB_TRANSFORM_QUALIFICATION.md`. |
