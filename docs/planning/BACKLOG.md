...
| W3-019 | PLANNED | S-EBA-03 and S-EBA-07 provide sidecar and Fake-workflow contracts; persist bounded incremental archive, volume and sidecar inventory Evidence without extraction, and report encryption, missing volumes, corruption and unsupported methods path-free. |
| W3-020 | PLANNED | S-EBA-04 und S-EBA-05 implementieren bounded lokale Secret Candidates und opaque `SecretHandle`-Metadaten. Die reale Passwortprüfung bleibt bis FG-A-SECRET blockiert; kein Klartext, Brute Force oder Online-Fallback ist zulässig. |
| W3-021 | NEXT | FG-A-RUNTIME, S-EBAR-01, S-EBAR-02, FG-A-IMAGE und S-EBAR-03 sind abgeschlossen; ADR-0041 akzeptiert FG-A-RUNTIME-AVAILABILITY. Als Nächstes implementiert S-EBAR-03A vor EBAR-04 den reviewten `archive-runtime-release/v1`-Record, die SHA-256-Bindung der Custom-SLSA-/SPDX-Evidence, kontrollierte Erstprovisionierung, Rotation/Revocation und die vollständig offline ausführbare Revalidierung des exakten Manifestdigests, OCI-Layouts, Docker Config und RootFS. `BOOTSTRAP_LOCKED`, lokales Inspect oder `7zzs i` dürfen allein nie Authority werden. Public Visibility und Source-Association sind Provisioning-/Refresh-Gates; fehlender oder beschädigter State, rückläufige Generation/Clock, Revocation oder Ablauf nach höchstens 90 Tagen ergeben fail-closed `TOOL_UNAVAILABLE`. Danach folgen EBAR-04 bis EBAR-06 für isolierten Runner, unverschlüsseltes Listing/Integrity und private sandboxed Testextraktion. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
| W3-022 | PLANNED | FG-A-PERSISTENCE muss nach stabiler Runtime zuerst Schema, Reuse und Writer-Fencing akzeptieren. Danach versionierte Archive-Member-Evidence nur für unveränderte Archive/Tools/Adapter/Profile/Secrets persistieren; CBR/CBZ/EPUB bleiben von entbehrlicher Verpackung getrennt. |
