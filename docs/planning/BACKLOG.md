...
| W3-021 | READY | FG-A-RUNTIME, S-EBAR-01/02, FG-A-IMAGE, S-EBAR-03/03A, EBAR-04, S-EBAR-02A, S-EBAR-02B und S-EBAR-02B2 sind abgeschlossen. ADR-0046 entscheidet FG-A-STORAGE-FAMILY mit orthogonalen Publication-, Storage- und Outer-Compression-Achsen; der unabhängige Review ist ohne P0/P1 abgeschlossen, das PR-Gate steht aus. Danach folgen finaler FG-A-FORMAT-LOCK, S-EBAR-02C und erst anschließend EBAR-05. Nicht belegbare Fälle und Routingwidersprüche bleiben formatgebunden fail-closed. Komprimierte TAR-Wrapper bleiben bis EBAR-06 `OUTER_COMPRESSION_ONLY` mit Storage `UNKNOWN`. stderr-Prosa und grobe 7-Zip-Exitcodes bleiben ohne Ursachen-Authority. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
