...
| S-W10-05D | NEXT | Ergänze `quarantine-recover` für genau eine opaque Run-ID, die feste ADR-0056-Recovery-Matrix und die synthetische Crash-/Recovery-End-to-End-Abnahme; unklare Zustände enden ohne weitere Mutation bei `MANUAL_REVIEW`. |
