...
| W3-021 | NEXT | FG-A-RUNTIME ist durch ADR-0039 akzeptiert. S-EBAR-01 und S-EBAR-02 folgen zuerst; FG-A-IMAGE muss danach den Build-/Supply-Chain-Vertrag akzeptieren, bevor S-EBAR-03 und EBAR-04 bis EBAR-06 die digest-gepinnte Docker/Linux-Runtime `archive-linux-container-runner/v1`, unverschlüsseltes Listing/Integrity und private sandboxed Testextraktion umsetzen. Die tatsächliche Source wird nie gemountet oder gelöscht; native Windows-Ausführung bleibt bis `FG-A-WINDOWS-SANDBOX` `TOOL_UNAVAILABLE`. |
