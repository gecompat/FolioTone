...
| W3-024 | IN PROGRESS | S-EBAR-08A bis 08C sind mit Models, Migration `0020`, geschlossenem Store, Fencing, restartbarer Planpartition und bounded Ausführung abgeschlossen. S-EBAR-08D liefert als nächste kleine Welle den read-only Status. Extraction, Secrets, Mutation und allgemeiner E-Book-Collection-Status bleiben getrennt. |
