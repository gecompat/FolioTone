...
| W3-012 | NEXT | Implement a versioned e-book quality Evidence profile, separate from identity, covering structural conformance, metadata completeness, readable text, cover presence and format-specific risk indicators. |
