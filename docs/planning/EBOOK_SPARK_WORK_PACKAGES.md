...
| S-EBAR-W01 | Reiner TAR-Rahmenprüfer und feste Wrapper-/stdin-Commands. Erlaubt: neue `src/foliotone/archive/wrapper_stream.py`, `src/foliotone/archive/sevenzip.py` sowie je eine fokussierte Unit-Testdatei. | 512-Byte-State-Machine, Headerchecksumme, gebundene Zahlengrammatik, Größen/Member/Totalgrenzen, Payload/Padding, mindestens zwei Nullblöcke, nullhaltiger Nachlauf, SHA-256/Bytecount. Keine Prozesse, Provider, Rawpersistenz oder Extraction. | Spark `high`; 5.4 Mini als Fallback. Bei TAR-Grammatik-/Privacyabweichung Terra `high`. |
