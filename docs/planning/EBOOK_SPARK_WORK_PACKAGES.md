...
S-EBAR-03A, EBAR-04, S-EBAR-02A und S-EBAR-02B abgeschlossen;
FG-A-FORMAT-LOCK offen; nächstes Paket S-EBAR-02B2
...
| FG-A-FORMAT-LOCK | Offen. [ADR-0045](../decisions/ADR-0045-archive-7zip-format-lock.md) akzeptiert nur das Kollisions-/Erweiterungsgate und verwirft den Happy-Path-Vorabkandidaten als nicht autoritativ. Vor dem finalen Lock sind S-EBAR-02B2 und FG-A-STORAGE-FAMILY erforderlich. |
...
| FG-A-STORAGE-FAMILY | Docs-only-Gate für orthogonale Publication Kind `NONE/EPUB/CBZ/CBR` und Storage Family `ZIP/RAR4/RAR5/SEVEN_Z/TAR/UNKNOWN`. | ZIP-basierte EPUB/CBZ und RAR4-/RAR5-basierte CBR behalten beide Achsen; Wrapper bleiben vor EBAR-06 Storage `UNKNOWN`. Compatibility, Profilversion und Migration der bisherigen `ArchiveFormatKind`-Lesepfade werden entschieden. | Sol `high`; offen. Stop bei kollidierendem Suffix-/Signatur-/Publication-Routing. |
| FG-A-FORMAT-LOCK | Finales Docs-only-Gate nach S-EBAR-02B2 und FG-A-STORAGE-FAMILY. | Akzeptiertes `archive-7zip-format-lock/v1` erfordert ein eingechecktes maschinenlesbares Lockartefakt plus getrennten Digest, alle gemessenen Profile und unsupported Matrixzellen sowie einen strikt verify-only Workflowcheck, der den Lock nie regeneriert. | Sol `high`; offen. Stop bei jeder Evidence-, Routing-, Link-, Encryption-, Privacy- oder Stale-Lücke. |
| S-EBAR-02C | Additiver Produktionsparser erst nach beiden Gates. Erlaubt: `src/foliotone/archive/signatures.py`, `src/foliotone/archive/sevenzip_slt.py`, `src/foliotone/archive/sevenzip.py` und bestehende fokussierte Signatur-/Parser-/Command-Tests. Kein Provider-, Runner-, Persistence-, Wrapper-, Extraction- oder Secret-Code. | Orthogonales Publication-/Storage-Routing und exakt final gelockte Profile. Wrapper werden vor Verbrauch des ersten Parserchunks abgewiesen; ein No-Provider-Call-Test gehört nicht hierher. Unveränderte Chunk-/Privacy-/v1-/v2-Regression. | Terra `medium`; bei Link-, Stream-, Routing- oder Privacysemantik Sol `high`. Stop bei Manifestabweichung, zusätzlicher Feldsemantik oder Wrapperbedarf. |
...
S-EBAR-01 bis S-EBAR-03A, EBAR-04, S-EBAR-02A, S-EBAR-02B sowie FG-A-IMAGE
und FG-A-RUNTIME-AVAILABILITY sind abgeschlossen. FG-A-FORMAT-LOCK bleibt
offen. Als Nächstes folgt S-EBAR-02B2; danach folgen FG-A-STORAGE-FAMILY,
finaler FG-A-FORMAT-LOCK und S-EBAR-02C. Erst danach werden EBAR-05 und
EBAR-06 fortgesetzt. Anschließend legt FG-A-PERSISTENCE den exakten
Schema- und Writer-Vertrag fest; erst dann darf S-EBAR-07 beginnen.
FG-A-SECRET kann später folgen und blockiert die unverschlüsselte Strecke
nicht.
