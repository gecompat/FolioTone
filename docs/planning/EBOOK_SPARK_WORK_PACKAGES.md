...
**Status:** In Ausführung; S-EBA-01 bis S-EBA-07 sowie S-EBAR-01 und
S-EBAR-02 abgeschlossen; FG-A-IMAGE durch ADR-0040 akzeptiert
...
| FG-A-IMAGE | Durch [ADR-0040](../decisions/ADR-0040-reproducible-archive-runtime-image.md) akzeptiert: projekt-eigenes `linux/amd64`-`scratch`-Rezept, feste 7zz-/Lizenzinputs, UID/GID `65532:65532`, gepinntes Buildx-/BuildKit-Profil, zweistufiger Plattform-Manifest-Digest-Lock, nachträgliche SBOM-/Provenance-Attestations sowie öffentliche/source-associated GHCR- und CI-Grenzen. |
...
S-EBAR-01, S-EBAR-02 und FG-A-IMAGE sind abgeschlossen. Als Nächstes setzt
S-EBAR-03 den Supply-Chain-Vertrag aus ADR-0040 mechanisch um; danach folgen
EBAR-04 bis EBAR-06 in dieser Reihenfolge. Danach legt
