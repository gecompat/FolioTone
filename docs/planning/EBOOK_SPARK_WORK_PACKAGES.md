...
| FG-W10-MOVE-BACKEND | Docs-only Auswahl eines echten atomaren No-Replace-Move-Backends. | Gleicher Volume-Kontext, kein Copy+Delete, Crash-/Race-/Collision-Nachweis auf einem echten Host; kein fest vorausgesetztes Dateisystem. | Sol `high`; BLOCKED und für eine spätere Frontier-Wave priorisiert. |
