...
| S-W10-02 | Additive immutable Authorization-/Run-Parents, append-only Eventpersistenz und neue Root-Lease-Owner-Klasse, weiterhin ohne Source-Mutation. | Bounded Read, Fencing, einmalige Authorization, PREPARED-/Recovery-Zustände, Collision und path-free Reportmaterial. | Terra `high`; als nächstes. |
