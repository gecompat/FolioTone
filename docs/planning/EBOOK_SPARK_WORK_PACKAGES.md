...
| S-W10-01 | Reine `quarantine-authorization/v1`-/`quarantine-execution/v1`-DTOs, kanonische Identität und Status-/Precondition-Reducer im ADR-0056-Scope. | Exakter APPROVED-Plan, zweite kurzlebige Authorization, ein Candidate, `KNOWN_NONE` für Candidate-Abhängigkeiten, keine Pfade und kein I/O. | Spark `high`; als nächstes. Terra `high` bei Status-/Review-/Lineagekonflikt. |
| S-W10-02 | Additive immutable Authorization-/Run-Parents, append-only Eventpersistenz und neue Root-Lease-Owner-Klasse, weiterhin ohne Source-Mutation. | Bounded Read, Fencing, einmalige Authorization, PREPARED-/Recovery-Zustände, Collision und path-free Reportmaterial. | Terra `high`; nach S-W10-01. |
| FG-W10-MOVE-BACKEND | Docs-only Auswahl eines echten atomaren No-Replace-Move-Backends. | Gleicher Volume-Kontext, kein Copy+Delete, Crash-/Race-/Collision-Nachweis auf einem echten Host; kein fest vorausgesetztes Dateisystem. | Sol `high`; nach S-W10-02, kein niedrigeres Fallback. |
| S-W10-03 | Gefenceter Ein-Datei-Quarantäneexecutor über genau den akzeptierten Backendadapter. | PREPARED vor Move, Full-Hash-/Handle-Revalidierung, atomarer No-Replace-Move, Restart/Manual-Review, keine Löschung. | Sol `high`; bis zum Backendgate blockiert. |
