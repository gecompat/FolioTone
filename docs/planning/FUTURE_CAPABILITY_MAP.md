...
| EPUB-Transformation | normalisierte EPUB-3-Ableitung mit getrennten Review-/Preserve-Metadaten in getrenntem Output-Root erzeugen | Option A und kombiniertes Profil positiv qualifiziert; `WI-0004` ist `READY` | ADR-0065, `DEC-0002`, `GATE-0001`, `GATE-0002`, `WI-0004` (`FUT-008`) | Plan-/Dry-Run-Vertrag, danach operation-spezifische Authority, Publish und Recovery in getrennten Waves |
