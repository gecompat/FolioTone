...
| W10-gate-gebunden | Entwicklung ist erlaubt; reale Ausführung benötigt den eigenen vollständigen Operationsvertrag |
...
abgeschlossen. ADR-0065 und `S-W9-007A` bis `S-W9-007C` liefern den
...
in `S-W10-RN01` bis `S-W10-RN04`. `FILE_REORGANIZE` bleibt getrennt hinter
...
| kontrollierte Mutation | geprüfte Pläne entsprechend ihrer Reversibilitätsklasse ausführen | ADR-0056-Quarantäne und ADR-0063/ADR-0064-EPUB-Titelwriter operativ; ADR-0065 plant sechs weitere Typen nicht ausführbar; ADR-0066 entscheidet davon nur Same-Parent-Rename | ADR-0056, ADR-0061, ADR-0063 bis ADR-0066, `W10-005`, `FG-W10-MOVE-BACKEND` und verbleibende operation-spezifische Write-Gates | `S-W10-RN01` bis `S-W10-RN04` abschließen; Sidecar-, externe Library-, Reorganisations-, Archive-, Rollback-, Purge- und Cleanup-Verträge getrennt entscheiden |
