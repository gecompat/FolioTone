...
| EPUB-Transformation | normalisierte EPUB-3-Ableitung mit reviewten Metadaten in getrenntem Output-Root erzeugen | nach negativem `GATE-0001` entscheidungs- und technisch blockiert | ADR-0065, `DEC-0002`, `GATE-0001`, `WI-0004` (`FUT-008`) | Verpackungs-/ToolProvider-Richtung, exakte Byte-Reproduzierbarkeit sowie aktuelle Tool-, Security- und Lizenzqualifikation |
