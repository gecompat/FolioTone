...
| EPUB-Transformation | normalisierte EPUB-3-Ableitung mit getrennten Review-/Preserve-Metadaten in getrenntem Output-Root erzeugen | Option A akzeptiert; `WI-0004` bleibt bis zum positiven `GATE-0002` technisch blockiert | ADR-0065, `DEC-0002`, `GATE-0001`, `GATE-0002`, `WI-0004` (`FUT-008`) | exakte Byte-Reproduzierbarkeit der kanonischen FolioTone-Normalisierung/-Verpackung sowie aktuelle Tool-, Security- und Lizenzqualifikation |
